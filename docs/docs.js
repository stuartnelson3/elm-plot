...
var _terezka$elm_plot$Internal_Draw$toLinePath = function (smoothing) {
	var _p34 = smoothing;
	if (_p34.ctor === 'None') {
...
var _terezka$elm_plot$Internal_Line$Config = F5(
	function (a, b, c, d, e) {
		return {stroke: a, strokeWidth: b, opacity: c, smoothing: d, customAttrs: e};
	});
...
var _terezka$elm_plot$Internal_Axis$view = F2(
	function (_p26, _p25) {
		...
		var _p31 = _p27;
		var _p28 = _p25;
		var _p30 = _p28.orientation;
		var _p29 = _p28;
		var axisPosition = A2(_terezka$elm_plot$Internal_Axis$getAxisPosition, _p27.scale.y, _p28.position);
		var tickValues = A2(_terezka$elm_plot$Internal_Axis$toTickValues, _p31, _p29);
		var labelValues = A2(_terezka$elm_plot$Internal_Axis$toLabelValues, _p29, tickValues);
		return A2(
			_elm_lang$svg$Svg$g,
			{
				ctor: '::',
				_0: A3(_terezka$elm_plot$Internal_Draw$classAttributeOriented, 'axis', _p30, _p28.classes),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A3(_terezka$elm_plot$Internal_Axis$viewAxisLine, _p28.lineConfig, _p31, axisPosition),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$svg$Svg$g,
						...
						A2(
							...
							A4(
								...
								_p29,
								axisPosition,
								A2(_terezka$elm_plot$Internal_Tick$toView, _p28.tickConfig, _p30)),
						...
						_0: A2(
							_elm_lang$svg$Svg$g,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$style(
										A2(_terezka$elm_plot$Internal_Axis$toAnchorStyle, _p28.anchor, _p30)),
									_1: {ctor: '[]'}
								}
							},
							A3(
								...
								_p28.labelConfig,
								A3(_terezka$elm_plot$Internal_Axis$placeLabel, _p31, _p29, axisPosition),
...
var _terezka$elm_plot$Internal_Grid$viewLines = F2(
	function (_p2, _p1) {
		...
		return A2(
			_elm_lang$core$List$map,
			A2(_terezka$elm_plot$Internal_Grid$viewLine, _p4.linesConfig, _p3),
			...
			_elm_lang$core$List$concat(
				{
					...
					_1: {
						ctor: '::',
						_0: A2(_terezka$elm_plot$Internal_Draw$toLinePath, config.smoothing, points),
						_1: {
							ctor: '::',
							_0: {
								ctor: '::',
...
var _terezka$elm_plot$Internal_Area$Config = F6(
	function (a, b, c, d, e, f) {
		return {stroke: a, strokeWidth: b, fill: c, opacity: d, smoothing: e, customAttrs: f};
	});
		...
		_1: {
			...
			_1: {
				...
				_0: _elm_lang$html$Html_Attributes$style(
					A2(
						_elm_lang$core$Basics_ops['++'],
						_terezka$elm_plot$Plot$sizeStyle(_p27.size),
						_p27.style)),
				_1: {ctor: '[]'}
			}
		}
...
var _terezka$elm_plot$Plot$viewPlot = F3(
	function (config, meta, _p28) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: A3(_terezka$elm_plot$Plot$viewSvg, meta, config, _p29._0),
				_1: _p29._1
			});
	});
...
var _terezka$elm_plot$Plot$getPosition = A2(
	...
	function (_p30) {
		var _p31 = _p30;
		return {ctor: '_Tuple2', _0: _p31.left, _1: _p31.top};
	},
...
var _terezka$elm_plot$Plot$getRelativePosition = F3(
	function (_p35, _p34, _p33) {
		var _p36 = _p35;
		var _p37 = _p34;
		var _p38 = _p33;
		var _p39 = _p36.fromSvgCoords(
			{ctor: '_Tuple2', _0: _p37._0 - _p38._0, _1: _p37._1 - _p38._1});
		var x = _p39._0;
		var y = _p39._1;
		return {
			ctor: '_Tuple2',
			_0: _p36.toNearestX(x),
			_1: y
		};
	});
var _terezka$elm_plot$Plot$shouldPositionUpdate = F2(
	function (_p41, _p40) {
		var _p42 = _p41;
		var _p43 = _p40;
		var _p44 = _p42.position;
		if (_p44.ctor === 'Nothing') {
			return true;
		} else {
			return (!_elm_lang$core$Native_Utils.eq(_p44._0._1, _p43._1)) || (!_elm_lang$core$Native_Utils.eq(_p44._0._0, _p43._0));
		}
	});
var _terezka$elm_plot$Plot$getHoveredValue = function (_p45) {
	var _p46 = _p45;
	return _p46._0.position;
};
var _terezka$elm_plot$Plot$rangeHighest = F2(
	function (toHighest, _p47) {
		var _p48 = _p47;
		return _elm_lang$core$Native_Utils.update(
			_p48,
			{
	...
	function (_p55, config) {
		...
		return _elm_lang$core$Native_Utils.update(
			config,
			{
				margin: {
					ctor: '_Tuple4',
					_0: _elm_lang$core$Basics$toFloat(_p56._0),
					_1: _elm_lang$core$Basics$toFloat(_p56._1),
					_2: _elm_lang$core$Basics$toFloat(_p56._2),
					_3: _elm_lang$core$Basics$toFloat(_p56._3)
				}
			});
	});
var _terezka$elm_plot$Plot$size = F2(
	function (_p57, config) {
		var _p58 = _p57;
		return _elm_lang$core$Native_Utils.update(
			config,
			{
				size: A2(
					...
					_elm_lang$core$Basics$toFloat(_p58._1))
			});
	});
...
var _terezka$elm_plot$Plot$update = F2(
	function (msg, _p61) {
		...
		var _p65 = _p62._0;
		var _p63 = msg;
		if (_p63.ctor === 'Hovering') {
			var _p64 = _p63._0;
			return A2(_terezka$elm_plot$Plot$shouldPositionUpdate, _p65, _p64) ? _terezka$elm_plot$Plot$State(
				_elm_lang$core$Native_Utils.update(
					_p65,
					{
						position: _elm_lang$core$Maybe$Just(_p64)
					})) : _terezka$elm_plot$Plot$State(_p65);
		} else {
...
var _terezka$elm_plot$Plot$toMouseOverMsg = F4(
	function (meta, mouseX, mouseY, position) {
		var relativePosition = A3(
			...
			position);
		var _p66 = _elm_lang$core$Tuple$first(relativePosition);
		if (_p66.ctor === 'Just') {
...
var _terezka$elm_plot$Plot$viewPlotInteractive = F3(
	function (config, meta, _p67) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: A3(_terezka$elm_plot$Plot$viewSvg, meta, config, _p68._0),
				_1: _p68._1
			});
	});
...
var _terezka$elm_plot$Plot_Attributes$smoothingBezier = function (config) {
	return _elm_lang$core$Native_Utils.update(
		config,
						...
						_terezka$elm_plot$Plot$area,
						{
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _terezka$elm_plot$Plot_Attributes$smoothingBezier,
										_1: {ctor: '[]'}
									}
								}
							}
